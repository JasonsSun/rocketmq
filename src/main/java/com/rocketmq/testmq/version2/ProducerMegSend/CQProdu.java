...
//@SpringBootTest
@Controller
public class CQProdu {

    private static final Logger logger = LoggerFactory.getLogger(CQProdu.class);
    ...
    public String sendCQMsg() {

        long times=System.currentTimeMillis();
        SendResult result = null;
        try {
            for(int i=0;i<10;i++) {
                Message sendMsg = new Message("CQTopic", "CQ",( "HelloCQ"+i).getBytes());
